const finance = {
  ...
  duplicateHarvestIncome: "{{count}} चक्र में कटाई की आय दोहरी गिनी गई हो सकती है: पूरी हुई कटाई योजना और दर्ज कटाई दोनों गिने गए हैं। कुल पर भरोसा करने से पहले एंट्री जाँचें।",
