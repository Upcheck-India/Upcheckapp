const farms = {
  ...
  detectLocation: 'আমার জেলা শনাক্ত করুন',
  ...
  locationDeniedMsg: 'আপনার জেলা অনুমান করতে অবস্থানের অনুমতি দিন। আপনি নিজেও বেছে নিতে পারেন।',
  locationError: 'আপনার অবস্থান পাওয়া যায়নি। আবার চেষ্টা করুন।',
  districtDetectFailedTitle: 'জেলা মেলেনি',
  districtDetectFailedMsg: 'তালিকা থেকে আপনার রাজ্য এবং জেলা বেছে নিন।',
  districtPickerPlaceholder: 'আপনার জেলা বেছে নিন',
  districtPickerChooseState: 'একটি রাজ্য বেছে নিন',
  districtPickerChooseDistrict: 'একটি জেলা বেছে নিন',
  districtPickerChange: 'পরিবর্তন',
  districtPickerNoResults: 'কোনো মিল নেই',
