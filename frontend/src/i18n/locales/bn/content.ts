const content = {
  ...
  tasks: {
    ...
    headerMyTasks: 'আমার কাজ',
    headerMyTasksWithFarm: 'আমার কাজ · {{farmName}}',
  ...
  news: {
    ...
    translate: {
      action: 'অনুবাদ করুন ও বুঝিয়ে দিন',
      copied: 'প্রম্পট ক্লিপবোর্ডে কপি হয়েছে',
      modalTitle: 'অনুবাদ করুন ও বুঝিয়ে দিন',
      modalBody: 'শেয়ার অপশন খোলা যায়নি। নিচের প্রম্পটটি কপি করে আপনার অনুবাদ অ্যাপে পেস্ট করুন।',
      copyButton: 'প্রম্পট কপি করুন',
      close: 'বন্ধ করুন',
      prompt: {
        instruction: 'এই সংবাদ প্রবন্ধটি বাংলায় অনুবাদ করুন এবং একজন চিংড়ি চাষির জন্য সহজ ভাষায় ব্যাখ্যা করুন। প্রথমে একটি লাইনে অনুবাদ দিন, তারপর একটি সংক্ষিপ্ত ব্যাখ্যা দিন।',
        headline: 'শিরোনাম',
        summary: 'সারাংশ',
        source: 'সূত্র',
