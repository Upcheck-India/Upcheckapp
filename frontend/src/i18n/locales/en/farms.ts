const farms = {
  ...
  locationDeniedMsg: 'Allow location access to guess your district. You can always pick it yourself.',
  locationError: 'Could not get your location. Try again.',
  districtDetectFailedTitle: "Couldn't match a district",
  districtDetectFailedMsg: 'Pick your state and district from the list instead.',
  districtPickerPlaceholder: 'Choose your district',
  districtPickerChooseState: 'Choose a state',
  districtPickerChooseDistrict: 'Choose a district',
  districtPickerChange: 'Change',
  districtPickerNoResults: 'No matches',
