const finance = {
  ...
  duplicateHarvestIncome: "{{count}} సైకిల్(ల)లో పంట ఆదాయం రెండుసార్లు లెక్కించబడి ఉండవచ్చు: పూర్తయిన పంట కోత ప్రణాళిక, నమోదైన పంట రెండూ లెక్కలో ఉన్నాయి. మొత్తాన్ని నమ్మే ముందు ఎంట్రీలను తనిఖీ చేయండి.",
