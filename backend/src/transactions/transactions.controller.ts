...
export class TransactionsController {
    ...
    @Get()
    findAll(@CurrentUser() user, @Query('farmId') farmId?: string, @Query('type') type?: string) {
    ...
    @Patch(':id')
    update(@CurrentUser() user, @Param('id') id: string, @Body() updateDto: UpdateTransactionDto) {
