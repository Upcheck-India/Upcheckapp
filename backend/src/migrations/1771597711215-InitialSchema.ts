...
export class InitialSchema1771597711215 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`UPDATE "ponds" SET "geometry_type" = 'rectangular' WHERE "geometry_type" IS NULL`);
        await queryRunner.query(`UPDATE "ponds" SET "construction_type" = 'earthen' WHERE "construction_type" IS NULL`);
        await queryRunner.query(`UPDATE "ponds" SET "depth_m" = 1.0 WHERE "depth_m" IS NULL`);
        await queryRunner.query(`UPDATE "ponds" SET "calculated_area_m2" = 0 WHERE "calculated_area_m2" IS NULL`);
