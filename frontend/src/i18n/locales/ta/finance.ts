const finance = {
  ...
  duplicateHarvestIncome: "{{count}} சுழற்சியில் அறுவடை வருமானம் இருமுறை கணக்கிடப்பட்டிருக்கலாம்: முடிந்த அறுவடைத் திட்டமும் பதிவு செய்த அறுவடையும் இரண்டும் சேர்க்கப்பட்டுள்ளன. மொத்தத்தை நம்புவதற்கு முன் பதிவுகளைச் சரிபார்க்கவும்.",
