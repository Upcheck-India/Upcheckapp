...
const storage = {
  ...
  ofLimit: '{{used}} of {{limit}} photos',
  limitRule: 'Your account keeps up to {{photos}} farm photos. Photos your workers add on your farms count here too; your profile picture and problem reports do not.',
  nearlyFull: 'Photo storage is {{pct}}% full.',
  almostFull: 'Photo storage is {{pct}}% full — free up space soon.',
  banner: {
    warn: 'You have used {{used}} of {{limit}} photos ({{pct}}%). Free up space before it fills.',
    critical: 'Almost full: {{used}} of {{limit}} photos used. Free up space now, or new photos cannot be added.',
  },
