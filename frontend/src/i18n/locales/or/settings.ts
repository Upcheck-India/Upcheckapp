const settings = {
  ...
  deleteAccountTitle: 'ଆକାଉଣ୍ଟ ବିଲୋପ କରନ୍ତୁ',
  deleteAccountWarningTitle: 'ଏହା ପୂର୍ବ ଅବସ୍ଥାକୁ ଫେରାଯାଇ ପାରିବ ନାହିଁ',
  deleteAccountWarningBody: 'ଆପଣଙ୍କ ଆକାଉଣ୍ଟ ବିଲୋପ କଲେ ତାହା ଏବଂ ଆପଣଙ୍କ ମାଲିକାନାର ସମସ୍ତ ଡାଟା ସ୍ଥାୟୀ ଭାବେ ହଟିଯିବ। ଆପଣଙ୍କୁ ତୁରନ୍ତ ସାଇନ୍ ଆଉଟ୍ କରାଯିବ।',
  deleteAccountWhatTitle: 'କ’ଣ ବିଲୋପ ହେବ',
  deleteAccountItemFarms: 'ଆପଣଙ୍କ ମାଲିକାନାର ସମସ୍ତ ଫାର୍ମ, ଏବଂ ସେମାନଙ୍କ ପୋଖରୀ ଓ ଚକ୍ର',
  deleteAccountItemLogs: 'ସମସ୍ତ ଜଳ, ଖାଦ୍ୟ, ନମୁନା ଓ ସ୍ୱାସ୍ଥ୍ୟ ରେକର୍ଡ',
  deleteAccountItemFinance: 'ସମସ୍ତ ଆର୍ଥିକ ରେକର୍ଡ, ଇନଭେଣ୍ଟୋରୀ ଓ ରିପୋର୍ଟ',
  deleteAccountItemTeam: 'ଅନ୍ୟ ଫାର୍ମରେ ଆପଣଙ୍କ ଟିମ୍ ସଦସ୍ୟତା',
  deleteAccountReuseNote: 'ଆପଣଙ୍କ ଇମେଲ୍ ମୁକ୍ତ ହୋଇଯିବ — ଆପଣ ପରେ ନୂଆ ଉପଭୋକ୍ତା ଭାବେ ପୁଣି ସାଇନ୍ ଅପ୍ କରିପାରିବେ।',
  deleteConfirmPrompt: 'ନିଶ୍ଚିତ କରିବାକୁ, ତଳେ ଥିବା ଲେଖାଟି ଠିକ୍ ସେହିପରି ଟାଇପ୍ କରନ୍ତୁ:',
  deleteConfirmLabel: 'ନିଶ୍ଚିତକରଣ',
  deleteConfirmWord: 'DELETE',
  deletePasswordLabel: 'ଆପଣଙ୍କ ପାସୱାର୍ଡ',
  deletePasswordHint: 'ଏହା ଆପଣ ହିଁ ବୋଲି ନିଶ୍ଚିତ କରିବାକୁ ଆପଣଙ୍କ ପାସୱାର୍ଡ ଦିଅନ୍ତୁ।',
