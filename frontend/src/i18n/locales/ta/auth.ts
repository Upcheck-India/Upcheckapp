const auth = {
  ...
  tcFallbackCta: 'Truecaller செயலி இல்லையா? உள்நுழைய வேறு வழிகள்',
  tcPhoneTitle: 'உள்நுழைய வேறு ஒரு வழி',
  tcPhoneSubtitle: 'இந்தச் சாதனத்தில் Truecaller ஒரு-தட்டு உள்நுழைவு கிடைக்கவில்லை. உங்கள் மின்னஞ்சல் அல்லது Google கணக்கைப் பயன்படுத்தி உள்நுழையவும்.',
  tcOtpBody: 'Truecaller வழங்கிய குறியீட்டை உள்ளிடவும்.',
  tcContinueWithEmail: 'மின்னஞ்சலுடன் தொடரவும்',
  tcVerify: 'சரிபார்',
