const content = {
  ...
  news: {
    ...
    noRecentNews: 'சமீபத்திய செய்திகள் இல்லை',
    noRecentNewsSubtitle: 'காட்ட புதிதாக எதுவும் இல்லை. மீண்டும் சரிபார்க்க கீழே இழுக்கவும்.',
    ago: '{{ago}} முன்பு',
    categories: {
      market: 'சந்தை & விலை',
    ...
    translate: {
      action: 'மொழிபெயர்த்து விளக்கவும்',
      copied: 'ப்ராம்ப்ட் கிளிப்போர்டுக்கு நகலெடுக்கப்பட்டது',
      modalTitle: 'மொழிபெயர்த்து விளக்கவும்',
      modalBody: 'பகிர் விருப்பம் திறக்கவில்லை. கீழேயுள்ள ப்ராம்ப்டை நகலெடுத்து உங்கள் மொழிபெயர்ப்பு ஆப்பில் ஒட்டவும்.',
      copyButton: 'ப்ராம்ப்டை நகலெடுக்கவும்',
      close: 'மூடு',
      prompt: {
        instruction: 'இந்தச் செய்திக் கட்டுரையை தமிழ் மொழியில் மொழிபெயர்த்து, ஓர் இறால் விவசாயிக்கு எளிய மொழியில் விளக்கவும். முதலில் ஒரு வரியில் மொழிபெயர்ப்பைத் தாருங்கள், பிறகு ஒரு சிறிய விளக்கம் தாருங்கள்.',
        headline: 'தலைப்பு',
        summary: 'சுருக்கம்',
        source: 'மூலம்',
