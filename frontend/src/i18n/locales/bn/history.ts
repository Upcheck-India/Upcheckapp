const history = {
  ...
  weeklyChemistryTitle: 'সাপ্তাহিক রসায়ন',
  weeklyChemistryEmptyTitle: 'এখনও কোনো রসায়ন পরীক্ষা নেই',
  weeklyChemistryEmptyText: 'টেস্ট-কিট রিডিং লিখুন, প্রতিটি প্যারামিটারের প্রবণতা এখানে দেখা যাবে।',
  weeklyChemistryLogAction: 'পরীক্ষা লিখুন',
  weeklyChemistryNeedsMore: 'প্রবণতা আঁকতে অন্তত দুটি পরীক্ষা দরকার।',
  weeklyChemistryEntries: 'সব পরীক্ষা',
