...
describe('PlanktonService — idempotent create (SYNC-2 offline replay)', () => {
  let service: PlanktonService;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        PlanktonService,
        { provide: getRepositoryToken(PlanktonData), useValue: repo },
      ],
    }).compile();
    service = module.get(PlanktonService);
  });
