const finance = {
  ...
  duplicateHarvestIncome: "{{count}}ଟି ଚକ୍ରରେ ଅମଳ ଆୟ ଦୁଇଥର ଗଣାଯାଇଥାଇପାରେ: ସମ୍ପୂର୍ଣ୍ଣ ଅମଳ ଯୋଜନା ଓ ଲଗ୍ କରାଯାଇଥିବା ଅମଳ ଦୁହେଁ ଗଣାଯାଇଛି। ମୋଟ ଉପରେ ଭରସା କରିବା ପୂର୍ବରୁ ଏଣ୍ଟ୍ରି ଯାଞ୍ଚ କରନ୍ତୁ।",
