const finance = {
  ...
  duplicateHarvestIncome: "{{count}}টি চক্রে ফসলের আয় দুবার গোনা হয়ে থাকতে পারে: সম্পন্ন ফসল কাটার পরিকল্পনা ও লগ করা ফসল দুটোই গোনা হয়েছে। মোটের উপর ভরসা করার আগে এন্ট্রিগুলো দেখুন।",
