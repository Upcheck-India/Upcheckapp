...
export class DatabaseQualityFixes1740487200000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_ponds_active_cycle_id" ON "ponds" ("active_cycle_id")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_crops_hatchery_id" ON "crops" ("hatchery_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_crops_species_id" ON "crops" ("species_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_crops_broodstock_id" ON "crops" ("broodstock_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_crops_is_active" ON "crops" ("is_active")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_water_quality_records_pond_id" ON "water_quality_records" ("pond_id")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_treatments_crop_id" ON "treatments" ("crop_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_treatments_product_id" ON "treatments" ("product_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_mortality_records_crop_id" ON "mortality_records" ("crop_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_chemical_data_crop_id" ON "chemical_data" ("crop_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_plankton_data_crop_id" ON "plankton_data" ("crop_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_microbiology_data_crop_id" ON "microbiology_data" ("crop_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_disease_records_crop_id" ON "disease_records" ("crop_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_disease_records_disease_id" ON "disease_records" ("disease_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_harvests_crop_id" ON "harvests" ("crop_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_sampling_data_pond_id" ON "sampling_data" ("pond_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_sampling_data_crop_id" ON "sampling_data" ("crop_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_simulations_pond_id" ON "simulations" ("pond_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_simulations_user_id" ON "simulations" ("user_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_expenses_pond_id" ON "expenses" ("pond_id")`,
    );
    await queryRunner.query(
    ...
    // ============================================================
    await queryRunner.query(
      `ALTER TABLE "water_quality_records" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "feed_records" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "treatments" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "mortality_records" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "chemical_data" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "plankton_data" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "microbiology_data" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "disease_records" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "sampling_data" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "simulations" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    await queryRunner.query(
    ...
    // ============================================================
    await queryRunner.query(
      `ALTER TABLE "harvests" ALTER COLUMN "created_at" TYPE TIMESTAMP WITH TIME ZONE USING "created_at"::TIMESTAMP WITH TIME ZONE`,
    );
    await queryRunner.query(
      `ALTER TABLE "harvests" ALTER COLUMN "updated_at" TYPE TIMESTAMP WITH TIME ZONE USING "updated_at"::TIMESTAMP WITH TIME ZONE`,
    );
    await queryRunner.query(
      `ALTER TABLE "expenses" ALTER COLUMN "created_at" TYPE TIMESTAMP WITH TIME ZONE USING "created_at"::TIMESTAMP WITH TIME ZONE`,
    );
    await queryRunner.query(
      `ALTER TABLE "expenses" ALTER COLUMN "updated_at" TYPE TIMESTAMP WITH TIME ZONE USING "updated_at"::TIMESTAMP WITH TIME ZONE`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "expenses" ALTER COLUMN "updated_at" TYPE TIMESTAMP USING "updated_at"::TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "expenses" ALTER COLUMN "created_at" TYPE TIMESTAMP USING "created_at"::TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "harvests" ALTER COLUMN "updated_at" TYPE TIMESTAMP USING "updated_at"::TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "harvests" ALTER COLUMN "created_at" TYPE TIMESTAMP USING "created_at"::TIMESTAMP`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "simulations" DROP COLUMN IF EXISTS "updated_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sampling_data" DROP COLUMN IF EXISTS "updated_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "disease_records" DROP COLUMN IF EXISTS "updated_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "microbiology_data" DROP COLUMN IF EXISTS "updated_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "plankton_data" DROP COLUMN IF EXISTS "updated_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "chemical_data" DROP COLUMN IF EXISTS "updated_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "mortality_records" DROP COLUMN IF EXISTS "updated_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "treatments" DROP COLUMN IF EXISTS "updated_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "feed_records" DROP COLUMN IF EXISTS "updated_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "water_quality_records" DROP COLUMN IF EXISTS "updated_at"`,
    );

    // Phase 2: Remove FK constraints
    await queryRunner.query(
      `ALTER TABLE "alerts" DROP CONSTRAINT IF EXISTS "FK_alerts_farm_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "alerts" DROP CONSTRAINT IF EXISTS "FK_alerts_pond_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "alerts" DROP CONSTRAINT IF EXISTS "FK_alerts_user_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "expenses" DROP CONSTRAINT IF EXISTS "FK_expenses_user_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "simulations" DROP CONSTRAINT IF EXISTS "FK_simulations_user_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "treatments" DROP CONSTRAINT IF EXISTS "FK_treatments_product_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "crops" DROP CONSTRAINT IF EXISTS "FK_crops_broodstock_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "crops" DROP CONSTRAINT IF EXISTS "FK_crops_species_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "crops" DROP CONSTRAINT IF EXISTS "FK_crops_hatchery_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "farms" DROP CONSTRAINT IF EXISTS "FK_farms_user_id"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_disease_records_disease_id"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_disease_records_crop_id"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_microbiology_data_crop_id"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_mortality_records_crop_id"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_water_quality_records_pond_id"`,
    );
