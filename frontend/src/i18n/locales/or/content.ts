const content = {
  ...
  tasks: {
    ...
    revertHint: "ପଛକୁ ନେବାକୁ ଦବାଇ ରଖନ୍ତୁ",
    // Delete confirmation
  ...
  news: {
    ...
    translate: {
      action: 'ଅନୁବାଦ କରି ବୁଝାନ୍ତୁ',
      copied: 'ପ୍ରମ୍ପ୍ଟ କ୍ଲିପବୋର୍ଡକୁ କପି ହେଲା',
      modalTitle: 'ଅନୁବାଦ କରି ବୁଝାନ୍ତୁ',
      modalBody: 'ସେୟାର୍ ବିକଳ୍ପ ଖୋଲିପାରିଲା ନାହିଁ। ତଳେ ଥିବା ପ୍ରମ୍ପ୍ଟକୁ କପି କରି ଆପଣଙ୍କ ଅନୁବାଦ ଆପ୍ ରେ ପେଷ୍ଟ କରନ୍ତୁ।',
      copyButton: 'ପ୍ରମ୍ପ୍ଟ କପି କରନ୍ତୁ',
      close: 'ବନ୍ଦ କରନ୍ତୁ',
      prompt: {
        instruction: 'ଏହି ସମ୍ବାଦ ଆର୍ଟିକ୍ଲଟିକୁ ଓଡ଼ିଆରେ ଅନୁବାଦ କରନ୍ତୁ ଏବଂ ଏକ ଚିଙ୍ଗୁଡ଼ି ଚାଷୀଙ୍କ ପାଇଁ ସରଳ ଭାଷାରେ ବୁଝାନ୍ତୁ। ପ୍ରଥମେ ଏକ ଧାଡ଼ିରେ ଅନୁବାଦ ଦିଅନ୍ତୁ, ତାପରେ ଏକ ଛୋଟ ବ୍ୟାଖ୍ୟା ଦିଅନ୍ତୁ।',
        headline: 'ଶୀର୍ଷକ',
        summary: 'ସାରାଂଶ',
        source: 'ଉତ୍ସ',
