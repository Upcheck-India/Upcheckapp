...
export class SupabaseService {
    ...
    async saveVerificationToken(userId: string, token: string, expiresAt: Date, type: string) {
    ...
    async deleteUserTokens(userId: string, type?: string) {
        let query = this.supabase.from('verification_tokens').delete().eq('user_id', userId);
    ...
    async savePasswordResetToken(userId: string, token: string, expiresAt: Date, type: string) {
