            ...
            <View style={styles.detailRow}>
                {item.totalSamples != null && (
                    <View style={styles.metricPill}>
                        <Text style={styles.pillLabel}>Samples</Text>
                        <Text style={styles.pillValue}>{item.totalSamples}</Text>
                    </View>
                )}
                {item.biomassEstimationKg != null && (
                    <View style={styles.metricPill}>
                        <Text style={styles.pillLabel}>Biomass</Text>
    ...
    return (
        <ScreenWrapper scroll={false} padded={false}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Sampling History</Text>
                <View style={{ width: 40 }} />
            </View>
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View style={styles.emptyState}>
                            ...
                            <Text style={styles.emptyTitle}>No Sampling Records</Text>
                            <Text style={styles.emptyText}>Start sampling to track growth over time.</Text>
                        </View>
                    }
                />
            )}
